...
public:
    ...
    int result( string& text1,  string& text2, int n1, int n2, vector<vector<int>>& dp) {
        ...
        if (text1[n1] == text2[n2]) {
            return dp[n1][n2] = 1 + result(text1, text2, n1 - 1, n2 - 1, dp);
        }

        return dp[n1][n2] = max(result(text1, text2, n1 - 1, n2, dp), result(text1, text2, n1, n2 - 1, dp));
    }
    ...
    int longestCommonSubsequence(string text1, string text2) {
        ...
        return result(text1, text2, n1 - 1, n2 - 1, dp);
    }
};